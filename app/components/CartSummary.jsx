    ...
    <>
      {fetchCartProductInfo.length > 0 && 
        <div className="mt-3 border border-solid border-gray-400 rounded-sm p-3 h-52">
          <h2 className="text-3xl lg:text-2xl font-semibold mb-3">Cart Summary</h2>
          <p className="text-lg mb-3">Total Amount: <span className="font-semibold text-xl text-primary">ksh. {fetchCartProductInfo.reduce((total, item) => total + item.subtotal, 0)}</span></p>
